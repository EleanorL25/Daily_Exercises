...
```{r}
Covid_df <- tibble::tibble(
  date = as.Date(c("2023-02-22", "2023-02-22", "2023-02-22", "2023-02-22", "2023-02-22")),
  county = c("Autauga", "Baldwin", "Barbour", "Bibb", "Blount"),
  fips = c(01001, 01003, 01005, 01007, 01009),
  cases = c(19732, 69641, 7451, 8067, 18616),
  deaths = c(230, 724, 112, 109, 261)
)
print(Covid_df)
```
